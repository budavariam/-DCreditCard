...
var CustomOrbitControls = function ( object, domElement ) {
	...
	this.update = function () {
		...
		return function update() {
			...
			if ( scope.enableDamping ) {
				...
				spherical.theta += sphericalDelta.theta; // NOTE: BAM
...
// This set of controls performs orbiting, dollying (zooming), and panning.
// Unlike TrackballControls, it maintains the "up" direction object.up (+Y by default).
// This is very similar to CustomOrbitControls, another set of touch behavior
//
...
var MapControls = function ( object, domElement ) {
	...
	CustomOrbitControls.call( this, object, domElement );
...
export { CustomOrbitControls, MapControls };